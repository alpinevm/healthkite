...
Sample-rich workouts are dominated by repetition: thousands of samples per workout, each with the same shape and ~70% structural overhead. Wirebody encodes those streams **column-major** instead of row-major.
