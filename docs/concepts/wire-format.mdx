...
- **`sampleEncoding: "columnar-v1"`** — see [Columnar encoding](/concepts/columnar-encoding).
- **`sources` array with `src` indices** — see [Provenance hoisting](/concepts/provenance-hoisting).
