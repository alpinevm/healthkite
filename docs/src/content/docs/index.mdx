...
3. **`healthkite-mcp`** — Rust MCP server, MIT-licensed, [public on GitHub](https://github.com/alpinevm/healthkite). Stdio transport, installed with Cargo on the same machine as your agent.
